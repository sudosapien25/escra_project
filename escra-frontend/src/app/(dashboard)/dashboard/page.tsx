  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4 md:gap-0 mb-3 sm:mb-6">
        ...
        <div className="pb-1">
          <h1 className="text-[30px] font-bold text-gray-900 dark:text-white mb-0">Dashboard</h1>
      ...
      <hr className="my-3 md:my-6 border-gray-200 dark:border-gray-700 cursor-default select-none" />
      ...
      <div className="flex flex-col md:flex-row gap-4">
        ...
        <Card className="flex flex-1 flex-col items-center text-center rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 min-h-[120px] min-w-0">
          <div className="mb-2 p-3 rounded-full bg-purple-100 dark:bg-purple-900/30 text-purple-800 dark:text-purple-400">
        ...
        <Card className="flex flex-1 flex-col items-center text-center rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 min-h-[120px] min-w-0">
          ...
          <p className="text-xl font-bold text-gray-900 dark:text-white">$5.2M</p>
      ...
      <div className="w-full mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card className="flex flex-col items-center text-center rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 min-h-[120px] min-w-0">
          <div className="mb-2 p-3 rounded-full bg-purple-100 dark:bg-purple-900/30 text-purple-800 dark:text-purple-400">
            {React.createElement(LuPen, { className: "text-2xl text-teal-600 dark:text-teal-400" } as IconBaseProps)}
          </div>
          <p className="text-sm text-gray-500 dark:text-gray-400">Pending Signatures</p>
        ...
        <Card className="flex flex-col items-center text-center rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 min-h-[120px] min-w-0">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">Wire Transfers Pending</p>
        ...
        <Card className="flex flex-col items-center text-center rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 min-h-[120px] min-w-0">
          <div className="mb-2 p-3 rounded-full bg-purple-100 dark:bg-purple-900/30 text-purple-800 dark:text-purple-400">
            ...
            <p className="text-xl font-bold text-gray-900 dark:text-white">14 days</p>
          </Card>
      </div>
      ...
      <Card className="p-6 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 overflow-x-auto">
        <div className="flex flex-col md:flex-row md:justify-between md:items-center mb-4 gap-4 md:gap-0 min-w-0">
          ...
          <button className="text-teal-600 dark:text-teal-400 hover:underline flex items-center text-sm px-3 py-1 border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 rounded-md whitespace-nowrap hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
            View All
        ...
        <div className="relative pl-6 min-w-0">
          ...
          <div className="absolute left-[23px] top-0 bottom-0 w-px bg-gray-200 dark:bg-gray-700 z-0"></div>
          <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <Card className="p-4 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
          <div className="flex justify-between items-start mb-2">
            <h4 className="text-md font-semibold text-gray-900 dark:text-white whitespace-nowrap overflow-hidden text-ellipsis">Property Sale Contract</h4>
          </div>
          ...
          <div className="flex justify-between items-end mt-4">
            <div className="">
              <button className="text-teal-600 dark:text-teal-400 hover:underline flex items-center text-sm px-3 py-1 border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 rounded-md hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                View
                {/* Placeholder for arrow icon */}
                <svg className="ml-1 w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path></svg>
              </button>
            ...
            <div className="flex flex-col items-end">
              <span className="text-xs font-semibold px-2 py-1 rounded-full bg-yellow-100 dark:bg-yellow-900/30 text-yellow-800 dark:text-yellow-400 border border-yellow-200 dark:border-yellow-800 whitespace-nowrap overflow-hidden text-ellipsis">In Progress</span>
        ...
        <Card className="p-4 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
          <div className="flex justify-between items-start mb-2">
            <h4 className="text-md font-semibold text-gray-900 dark:text-white whitespace-nowrap overflow-hidden text-ellipsis">Commercial Lease Escrow</h4>
          </div>
          <div className="text-sm text-gray-700 dark:text-gray-300 space-y-1">
          ...
          <div className="flex justify-between items-end mt-4">
            ...
            <div className="flex flex-col items-end">
              <span className="text-xs font-semibold px-2 py-1 rounded-full bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-400 border border-blue-200 dark:border-blue-800 whitespace-nowrap overflow-hidden text-ellipsis">Document Review</span>
        ...
        <Card className="p-4 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
          <div className="flex justify-between items-start mb-2">
            <h4 className="text-md font-semibold text-gray-900 dark:text-white whitespace-nowrap overflow-hidden text-ellipsis">Construction Escrow</h4>
          </div>
          <div className="text-sm text-gray-700 dark:text-gray-300 space-y-1">
          ...
          <div className="flex justify-between items-end mt-4">
            ...
            <div className="flex flex-col items-end">
              <span className="text-xs font-semibold px-2 py-1 rounded-full bg-purple-100 dark:bg-purple-900/30 text-purple-800 dark:text-purple-400 border border-purple-200 dark:border-purple-800 whitespace-nowrap overflow-hidden text-ellipsis">Initial Setup</span>
